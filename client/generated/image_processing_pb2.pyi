...
class ImageProcessingResponse(_message.Message):
    __slots__ = ("output_image", "output_format", "width", "height")
    ...
    width: int
    height: int
    def __init__(self, output_image: _Optional[bytes] = ..., output_format: _Optional[str] = ..., width: _Optional[int] = ..., height: _Optional[int] = ...) -> None: ...
